...
// import RSDGradientPurple from "../../public/assets/rsd-gradient-purple.svg"
// import RSDGradient from "../../public/assets/glyphs/rsd-gradient.svg"

interface RSDGlyphGradientProps extends ImageProps {
  purple?: boolean
}

export const RSDGlyphGradient = ({
  purple,
  ...props
}: RSDGlyphGradientProps) => {
  return <Image alt="RSD-glyph" src={purple ? "" : ""} {...props} />
}

export const RSDGlyphSolid = ({ color, ...props }: IconProps) => {
  return (
